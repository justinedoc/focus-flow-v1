...
function FeaturesCard({ feature }: FeaturesCardProp) {
  ...
  return (
    <main className="flex flex-col justify-center items-center max-w-[20rem] sm:max-w-[100%] p-5 rounded-lg shadow-md border border-[#F1F1F1] cursor-pointer transition duration-500 hover:scale-105">
