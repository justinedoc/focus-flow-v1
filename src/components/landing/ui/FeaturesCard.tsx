...
function FeaturesCard({ feature }: FeaturesCardProp) {
  ...
  return (
    <main className="flex flex-col justify-center items-center max-w-[20rem] sm:max-w-[100%] p-5 rounded-lg shadow-md">
      <img src={image} alt="feature image" className="w-40" />
