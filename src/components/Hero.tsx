...
function Hero() {
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-between bg-heroBg relative p-5 md:px-36 md:py-10 h-fit bg-no-repeat bg-cover bg-bottom overflow-hidden">
      <main>
        <h1 className="text-[4rem] font-bold leading-tight my-5">
